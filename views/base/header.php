...
<head>
    ...
    <script>
      ...
      fbq('init', '2109287939401487');
      fbq('track', 'PageView');
      fbq('track', 'ViewContent');
    </script>
    <noscript><img height="1" width="1" style="display:none"
                   src="https://www.facebook.com/tr?id=2109287939401487&ev=PageView&noscript=1"
        /></noscript>
...
<!--<img height="1" width="1" style="display:none"-->
<!--     src="https://www.facebook.com/tr?id=1979206859020901&ev=ViewContent&noscript=1" />-->
<!---->
<!--<img height="1" width="1" style="display:none"-->
<!--     src="https://www.facebook.com/tr?id=264654440978563&ev=PageView&noscript=1"/>-->
<!--<img height="1" width="1" style="display:none"-->
<!--     src="https://www.facebook.com/tr?id=264654440978563&ev=ViewContent&noscript=1"/>-->

<img height="1" width="1" style="display:none"
     src="https://www.facebook.com/tr?id=336657536913648&ev=PageView&noscript=1"
/>
<img height="1" width="1" style="display:none"
     src="https://www.facebook.com/tr?id=336657536913648&ev=ViewContent&noscript=1"
/>
...
/>
<img height="1" width="1" style="display:none"
     src="https://www.facebook.com/tr?id=250981605584023&ev=ViewContent&noscript=1"
/>
...
<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
    ...
    <symbol id="instagram-icon" viewBox="0 0 225 225">
        <path d="M0,0v225h225V0H0z M113,78.667c18.38,0,33.333,14.953,33.333,33.333S131.38,145.333,113,145.333S79.667,130.38,79.667,112  S94.62,78.667,113,78.667z M30,26h34v22H30V26z M195,195H30v-79h19.806c2.073,33.064,29.616,59.333,63.194,59.333  s61.121-26.269,63.194-59.333H195V195z"/>
    </symbol>
    ...
    <symbol id="arrow_prev-icon" viewBox="0 0 31.494 31.494">
        <path d="M10.273,5.009c0.444-0.444,1.143-0.444,1.587,0c0.429,0.429,0.429,1.143,0,1.571l-8.047,8.047h26.554
            c0.619,0,1.127,0.492,1.127,1.111c0,0.619-0.508,1.127-1.127,1.127H3.813l8.047,8.032c0.429,0.444,0.429,1.159,0,1.587
            c-0.444,0.444-1.143,0.444-1.587,0l-9.952-9.952c-0.429-0.429-0.429-1.143,0-1.571L10.273,5.009z"/>
    </symbol>

    <symbol id="arrow_next-icon" viewBox="0 0 31.49 31.49">
        <path d="M21.205,5.007c-0.429-0.444-1.143-0.444-1.587,0c-0.429,0.429-0.429,1.143,0,1.571l8.047,8.047H1.111
	        C0.492,14.626,0,15.118,0,15.737c0,0.619,0.492,1.127,1.111,1.127h26.554l-8.047,8.032c-0.429,0.444-0.429,1.159,0,1.587
	        c0.444,0.444,1.159,0.444,1.587,0l9.952-9.952c0.444-0.429,0.444-1.143,0-1.571L21.205,5.007z"/>
    </symbol>

    <symbol id="play_video-icon" viewBox="0 0 50 50">
