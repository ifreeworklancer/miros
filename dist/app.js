...
(function () {
  ...
  $('ul.presentation-tabs-list').on('click', 'li:not(.active)', function () {
    $(this).addClass('active').siblings().removeClass('active').closest('section#presentation').find('div.presentation-tabs-content-item').removeClass('active').eq($(this).index()).addClass('active');
  });
  ...
  $('[data-wallet]').on('click', function (e) {
    ...
    $('.purchased-wallet').html("<div class='purchased-wallet-item'><div class='purchased-wallet-item__title'>Выбранный товар</div><div class='purchased-wallet-item__text'>" + name + "</div></div><div class='purchased-wallet-item'><div class='purchased-wallet-item__title'>Цена</div><div class='purchased-wallet-item__text'>" + value + "</div></div><div class'purchased-wallet__img'><img src='" + img + "' alt='" + name + "')>");
